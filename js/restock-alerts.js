/**
 * RESTOCK-ALERTS.JS v1.1
 * v1.1 (auditoria): tocar no aviso abre os Favoritos (antes, se a lista
 *    de favoritos já estivesse aberta, o toque fechava ela).
...
const RestockAlerts = {
    ...
    _showRestockToast(productName) {
        ...
        toast.addEventListener('click', () => {
            ...
            if (products && !products.showFavoritesOnly) products.toggleShowFavorites();
        });
