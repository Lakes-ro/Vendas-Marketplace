...
const Tenants = {
    ...
    renderSupremeAdmins() {
        ...
        // ✅ NOVO: só a conta fundadora vê os botões de conceder/revogar
        ...
        list.innerHTML = this.supremeAdmins.map(admin => {
            ...
            // ✅ NOVO: permissão de "Fechar a Loja Inteira" — separada do
            // cargo de Admin Supremo. Fundador sempre tem e não pode ser
            // alterada; qualquer outro admin só tem se a conta fundadora
            // conceder aqui.
     ...
     * pro diretor da i            this.tenants = sellers || [];
